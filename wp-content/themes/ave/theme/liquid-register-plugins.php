...
function _s_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => esc_html__( 'Redux Framework', 'ave' ),
			'slug' 		         => 'redux-framework',
			'required' 	         => true,
			'liquid_logo'        => $images . '/redux.png',
			'liquid_author'      => esc_html__( 'Team Redux', 'ave' ),
			'liquid_description' => esc_html__( 'Redux is a simple, truly extensible and fully responsive options framework for WordPress themes and plugins.', 'ave' )
		),
		array(
