...
return array(
	'post_type'    => 'page',
	'post_title'   => _x( 'Contact', 'Theme starter content', 'sparklestore' ),
	...
	'post_content' => '<!-- wp:columns {"align":"full"} -->
		...
		<div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"className":"sparklestore-title"} -->
		<h2 class="sparklestore-title">Send us a message</h2>
		<!-- /wp:heading -->
		...
		<!-- wp:column {"width":"50%"} -->
		<div class="wp-block-column" style="flex-basis:50%"><!-- wp:heading {"textAlign":"left","level":4,"className":"sparklestore-title","style":{"typography":{"fontSize":18},"color":{"text":"#3c4858"}}} -->
		<h4 class="has-text-align-left sparklestore-title has-text-color" style="color:#3c4858;font-size:18px"><strong>Find us at the office</strong></h4>
		<!-- /wp:heading -->
		...
		<!-- wp:heading {"textAlign":"left","level":4,"className":"sparklestore-title","style":{"typography":{"fontSize":18},"color":{"text":"#3c4858"}}} -->
		<h4 class="has-text-align-left sparklestore-title has-text-color" style="color:#3c4858;font-size:18px"><strong><strong>Give us a ring</strong></strong></h4>
		<!-- /wp:heading -->
		...
		<!-- wp:heading {"textAlign":"left","level":4,"className":"sparklestore-title","style":{"color":{"text":"#3c4858"},"typography":{"fontSize":18}}} -->
		<h4 class="has-text-align-left sparklestore-title has-text-color" style="color:#3c4858;font-size:18px"><strong>  <strong>Legal information</strong></strong></h4>
		<!-- /wp:heading -->
